<?php 
	...
	{
		$query = "UPDATE faq SET question='".$_POST['question']."', answer='".$_POST['answer']."' WHERE FAQID='".$_POST['question']."'";
		//var_dump($query);
...
<form name='editFAQ' enctype="multipart/form-data" method='POST' 
	...
	<tr>
		...
		<td>
			...
			name='answer' rows='10' maxlength='1024' value='<?php echo $answer; ?>' /> </textarea>
		</td>
	</tr>
