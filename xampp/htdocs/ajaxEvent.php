...
// EVENT TRIGGER
	if($_POST['t'] == 1)
	{
		...
		if ($row['eventID'] == NULL)
		{
			...
			$_SESSION['errMsg'] = "<font class='error'>You have not booked an Event yet</font>";
...
// TOURNAMENT TRIGGER
	else if ($_POST['t'] == 2)
	{
		...
		if ($row['tournID'] == NULL)
		{
			...
			$_SESSION['errMsg'] = "<font class='error'>You have not booked a Tournament yet</font>";
	...
	else if ($_POST['t'] == 3)
	{
		...
		if ($row['tournID'] == NULL)
		{
			...
			echo "<tfoot><tr><td align='center' height='60px'>";
				echo "<font class='error'>You must book a tournament before you can reserve a seat</font>"; 
			echo "</td></tr></tfoot>";
			echo "</table>";
		}
		else
...
<?php
	...
	$off = "this.style.backgroundColor='white'";
