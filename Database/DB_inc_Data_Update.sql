...
--
-- Host: localhost
-- Generation Time: Apr 27, 2012 at 02:11 PM
...
-- Database: `cassa_lan`
--
CREATE DATABASE `cassa_lan` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cassa_lan`;
...
CREATE TABLE IF NOT EXISTS `attendee` (
  ...
  `seatID` tinyint(4) NOT NULL COMMENT 'Foreign Key',
  `eventID` smallint(6) NOT NULL COMMENT 'Foreign Key(eventID)',
  `clientID` smallint(6) NOT NULL COMMENT 'Foreign Key(clientID)',
  `tournID` smallint(6) NOT NULL COMMENT 'Foreign Key(tournID)',
  `paid_Admission` char(4) NOT NULL,
  PRIMARY KEY (`attendeeID`),
  KEY `eventID` (`eventID`,`clientID`,`tournID`),
  KEY `clientID` (`clientID`,`tournID`),
  KEY `tournID` (`tournID`),
  KEY `seatID` (`seatID`)
...
INSERT INTO `attendee` (`attendeeID`, `seatID`, `eventID`, `clientID`, `tournID`, `paid_Admission`) VALUES
(1, 5, 2, 4, 1, 'yes'),
(2, 10, 2, 10, 1, 'no'),
(3, 7, 2, 3, 1, 'yes'),
(4, 2, 2, 2, 2, 'yes'),
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `admin` binary(1) NOT NULL COMMENT '0= no, 1= yes',
...
INSERT INTO `client` (`clientID`, `username`, `password`, `first_name`, `last_name`, `mobile`, `email`, `admin`) VALUES
(1, 'nash@hotmail.com', 'pass123', 'tinashe', 'masvaure', '0432488797', 'nash@hotmail.com', '0'),
(2, 'james@google.com', 'jgoogle', 'james', 'flick', '0433245676', 'james@google.com', '0'),
(3, 'marryan@yahoo.com', 'myahoo', 'marry', 'jane', '0455643678', 'marryan@yahoo.com', '0'),
(4, 'tomwee@gmail.com', 'lovefacebook', 'tom', 'grudge', '0412345678', 'tomwee@gmail.com', '0'),
(5, 'kimy@ecu.com', 'kimecu', 'kim', 'kay', '0487654321', 'kimy@ecu.com', '0'),
(6, 'jimmycash@gmail.com', 'jim101', 'jimmy', 'cash', '0455436781', 'jummycash@gmail.com', '0'),
(7, 'dman@hotmail.com', 'mand101', 'dwayne', 'wayne', '0478987632', 'dman@hotmail.com', '0'),
(8, 'sindypink@gmail.com', 'pinkfirday', 'sindy', 'lackson', '0421454376', 'sindypink@gmail.com', '0'),
(9, 'crazyfox@yahoo.com', 'crazy101', 'clare', 'mcdonald', '0433456512', 'crazyfox@yahoo.com', '0'),
(10, 'crystall@gmail.com', 'poledancer101', 'christy', 'marks', '0897625378', 'crystall@gmail.com', '0');
...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `IP_address_low` varchar(28) NOT NULL,
  `IP_address_hi` varchar(28) NOT NULL,
  `event_started` bit(1) NOT NULL,
  PRIMARY KEY (`eventID`)
...
INSERT INTO `event` (`eventID`, `event_name`, `event_location`, `startTime`, `seatQuantity`, `server_IP_address`, `IP_address_low`, `IP_address_hi`, `event_started`) VALUES
(1, 'Cassa Royal', 'Mt Lawly', '2012-04-29 11:35:00', 80, '192.168.1.25', '192.168.1.26', '192.168.1.106', b'1'),
(2, 'Battle of the Nerds', 'Mt Lawly', '2012-09-25 08:00:00', 75, '192.168.1.107', '192.168.1.108', '192.168.1.183', b'0');
...
CREATE TABLE IF NOT EXISTS `pizza_order` (
  ...
  `paid_pizza` binary(1) NOT NULL COMMENT '0= no, 1= yes',
  PRIMARY KEY (`orderID`),
...
INSERT INTO `pizza_order` (`orderID`, `pizzaID`, `attendeeID`, `quantity`, `seat_number`, `paid_pizza`) VALUES
(1, 4, 1, 2, 10, 'y'),
(2, 1, 2, 1, 20, 'n'),
(3, 3, 3, 4, 32, 'y'),
(4, 1, 5, 1, 45, 'y'),
...
(1, 'four seasons', 'full of vegies', 5.20),
...
INSERT INTO `seat` (`seatID`, `status`, `seat_number`) VALUES
(1, 'N', 44),
(2, 'Y', 45),
(3, 'N', 76),
(4, 'Y', 56),
...
--
-- Dumping data for table `team_attendee`
--

INSERT INTO `team_attendee` (`teamID`, `attendeeID`) VALUES
(1, 1),
(1, 2),
(1, 3),
(1, 5);
...
INSERT INTO `teams` (`teamID`, `team_name`, `team_password`, `player_count`, `wins`) VALUES
(1, 'NERDS', 'wethenerds', 4, 1),
(2, 'geeks', 'loveglee', 2, 0),
(3, 'crazies', 'insane', 9, 0),
(4, 'jelly', 'tghyt', 3, 0),
(5, 'wethebest', 'bestest101', 4, 0),
(6, 'students', 'boredkids', 5, 0),
(7, 'loonsy', 'nerdybynature', 3, 0);
...
CREATE TABLE IF NOT EXISTS `tournament` (
  ...
  `started` binary(1) NOT NULL COMMENT '0=no,1=yes',
  PRIMARY KEY (`tournID`),
  KEY `eventID` (`eventID`)
...
INSERT INTO `tournament` (`tournID`, `eventID`, `name`, `date`, `start_time`, `end_time`, `winner`, `started`) VALUES
(1, 2, 'CassaLAN', '2012-09-25', '09:00:00', '18:00:00', 'NERDS', 'y'),
(2, 2, 'NERDY_GAMERS', '2012-09-25', '13:00:00', '15:00:00', '', 'n'),
(3, 1, 'Killer_Geeks', '2012-04-29', '09:00:00', '12:00:00', '', 'n'),
(4, 1, 'Assin_Games', '2012-04-29', '08:00:00', '12:00:00', '', 'y'),
(5, 1, 'TeamDeathMatch', '2012-04-29', '15:00:00', '18:00:00', '', 'n');
...
ALTER TABLE `attendee`
  ...
  ADD CONSTRAINT `attendee_ibfk_2` FOREIGN KEY (`clientID`) REFERENCES `client` (`clientID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `attendee_ibfk_3` FOREIGN KEY (`tournID`) REFERENCES `tournament` (`tournID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `attendee_ibfk_4` FOREIGN KEY (`seatID`) REFERENCES `seat` (`seatID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `pizza_order`
  ADD CONSTRAINT `pizza_order_ibfk_2` FOREIGN KEY (`pizzaID`) REFERENCES `pizza_type` (`pizzaID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pizza_order_ibfk_3` FOREIGN KEY (`attendeeID`) REFERENCES `attendee` (`attendeeID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pizza_order_ibfk_4` FOREIGN KEY (`seat_number`) REFERENCES `seat` (`seat_number`) ON DELETE CASCADE ON UPDATE CASCADE;
...
('def', 'cassa_lan', 'attendee', 'attendeeID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', 'auto_increment', 'select,insert,update,references', 'Primary Key, Auto_increment'),
('def', 'cassa_lan', 'attendee', 'seatID', 2, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', 'MUL', '', 'select,insert,update,references', 'Foreign Key'),
('def', 'cassa_lan', 'attendee', 'eventID', 3, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(eventID)'),
('def', 'cassa_lan', 'attendee', 'clientID', 4, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(clientID)'),
('def', 'cassa_lan', 'attendee', 'tournID', 5, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(tournID)'),
('def', 'cassa_lan', 'attendee', 'paid_Admission', 6, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'client', 'clientID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', 'auto_increment', 'select,insert,update,references', 'Primary Key, Auto_increment'),
('def', 'cassa_lan', 'client', 'username', 2, NULL, 'NO', 'varchar', 256, 256, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'client', 'password', 3, NULL, 'NO', 'varchar', 64, 64, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'client', 'first_name', 4, NULL, 'NO', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'client', 'last_name', 5, NULL, 'NO', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'client', 'mobile', 6, NULL, 'NO', 'char', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(10)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'client', 'email', 7, NULL, 'NO', 'varchar', 256, 256, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'client', 'admin', 8, NULL, 'NO', 'binary', 1, 1, NULL, NULL, NULL, NULL, 'binary(1)', '', '', 'select,insert,update,references', '0= no, 1= yes'),
('def', 'cassa_lan', 'event', 'eventID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', 'auto_increment', 'select,insert,update,references', 'Primary Key, Auto_increment'),
('def', 'cassa_lan', 'event', 'event_name', 2, NULL, 'NO', 'varchar', 64, 64, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'event', 'event_location', 3, NULL, 'NO', 'varchar', 128, 128, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(128)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'event', 'startTime', 4, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'event', 'seatQuantity', 5, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'event', 'server_IP_address', 6, NULL, 'NO', 'varchar', 28, 28, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(28)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'event', 'IP_address_low', 7, NULL, 'NO', 'varchar', 28, 28, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(28)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'event', 'IP_address_hi', 8, NULL, 'NO', 'varchar', 28, 28, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(28)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'event', 'event_started', 9, NULL, 'NO', 'bit', NULL, NULL, 1, NULL, NULL, NULL, 'bit(1)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'menu_items', 'menuID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(menuID)'),
('def', 'cassa_lan', 'menu_items', 'pizzaID', 2, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(pizzaID)'),
('def', 'cassa_lan', 'news', 'newsID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'news', 'subject', 2, NULL, 'NO', 'varchar', 64, 64, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'news', 'date', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'news', 'author', 4, NULL, 'NO', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'news', 'message', 5, NULL, 'NO', 'varchar', 800, 800, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(800)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'news', 'image', 6, NULL, 'YES', 'varchar', 256, 256, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'news', 'tag', 7, NULL, 'YES', 'varchar', 64, 64, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'pizza_menu', 'menuID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', 'auto_increment', 'select,insert,update,references', 'Primary Key, Auto_increment'),
('def', 'cassa_lan', 'pizza_menu', 'eventID', 2, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(eventID)'),
('def', 'cassa_lan', 'pizza_menu', 'menu_name', 3, NULL, 'NO', 'varchar', 28, 28, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(28)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'pizza_order', 'orderID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', 'auto_increment', 'select,insert,update,references', 'Primary Key, Auto_increment'),
('def', 'cassa_lan', 'pizza_order', 'pizzaID', 2, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(pizzaID)'),
('def', 'cassa_lan', 'pizza_order', 'attendeeID', 3, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(attendeeID)'),
('def', 'cassa_lan', 'pizza_order', 'quantity', 4, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'pizza_order', 'seat_number', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'pizza_order', 'paid_pizza', 6, NULL, 'NO', 'binary', 1, 1, NULL, NULL, NULL, NULL, 'binary(1)', '', '', 'select,insert,update,references', '0= no, 1= yes'),
('def', 'cassa_lan', 'pizza_type', 'pizzaID', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(11)', 'PRI', 'auto_increment', 'select,insert,update,references', 'Primary Key, Auto_increment'),
('def', 'cassa_lan', 'pizza_type', 'pizza_name', 2, NULL, 'NO', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'pizza_type', 'description', 3, NULL, 'NO', 'varchar', 128, 128, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(128)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'pizza_type', 'price', 4, NULL, 'NO', 'double', NULL, NULL, 4, 2, NULL, NULL, 'double(4,2)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'seat', 'seatID', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', 'PRI', 'auto_increment', 'select,insert,update,references', 'Primary Key, Auto_increment'),
('def', 'cassa_lan', 'seat', 'status', 2, NULL, 'NO', 'char', 1, 1, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(1)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'seat', 'seat_number', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'team_attendee', 'teamID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(teamID)'),
('def', 'cassa_lan', 'team_attendee', 'attendeeID', 2, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(attendeeID)'),
('def', 'cassa_lan', 'teams', 'teamID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', 'auto_increment', 'select,insert,update,references', 'Primary Key, Auto_increment'),
('def', 'cassa_lan', 'teams', 'team_name', 2, NULL, 'NO', 'varchar', 64, 64, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(64)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'teams', 'team_password', 3, NULL, 'NO', 'varchar', 64, 64, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'teams', 'player_count', 4, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'teams', 'wins', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'tournament', 'tournID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', 'auto_increment', 'select,insert,update,references', 'Primary Key, Auto_increment'),
('def', 'cassa_lan', 'tournament', 'eventID', 2, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'MUL', '', 'select,insert,update,references', 'Foreign Key(eventID)'),
('def', 'cassa_lan', 'tournament', 'name', 3, NULL, 'NO', 'varchar', 64, 64, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'tournament', 'date', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'tournament', 'start_time', 5, NULL, 'NO', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'tournament', 'end_time', 6, NULL, 'NO', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'tournament', 'winner', 7, NULL, 'NO', 'varchar', 64, 64, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'cassa_lan', 'tournament', 'started', 8, NULL, 'NO', 'binary', 1, 1, NULL, NULL, NULL, NULL, 'binary(1)', '', '', 'select,insert,update,references', '0=no,1=yes'),
...
-- in use (#1548 - Cannot load from mysql.event. The table is probably corrupted)
...
('COM_SHOW_TABLE_STATUS', '300'),
('COM_SHOW_TABLES', '41'),
('COM_SHOW_TRIGGERS', '138'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '106'),
('CREATED_TMP_DISK_TABLES', '536'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '1425'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '4'),
('HANDLER_READ_FIRST', '186'),
('HANDLER_READ_KEY', '149'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '1541'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '11052'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '2'),
('HANDLER_WRITE', '8837'),
('INNODB_BUFFER_POOL_PAGES_DATA', '431'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '662'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7760'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '20627'),
('INNODB_BUFFER_POOL_READS', '424'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1849'),
...
('INNODB_DATA_WRITES', '453'),
('INNODB_DATA_WRITTEN', '10972160'),
('INNODB_DBLWR_PAGES_WRITTEN', '331'),
('INNODB_DBLWR_WRITES', '27'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '162'),
('INNODB_LOG_WRITES', '78'),
...
('INNODB_ROWS_INSERTED', '87'),
('INNODB_ROWS_READ', '839'),
('INNODB_ROWS_UPDATED', '2'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '14328'),
('KEY_BLOCKS_USED', '19'),
('KEY_READ_REQUESTS', '70'),
('KEY_READS', '18'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '119458'),
('UPTIME_SINCE_FLUSH_STATUS', '119458');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\Addletrans-PC.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\Addletrans-PC.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\Addletrans-PC-slow.log'),
('CHARACTER_SET_SYSTEM', 'utf8'),
('SYSTEM_TIME_ZONE', 'W. Australia Standard Time'),
...
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'attendee', 'attendeeID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'attendee_ibfk_1', 'def', 'cassa_lan', 'attendee', 'eventID', 1, 1, 'cassa_lan', 'event', 'eventID'),
('def', 'cassa_lan', 'attendee_ibfk_2', 'def', 'cassa_lan', 'attendee', 'clientID', 1, 1, 'cassa_lan', 'client', 'clientID'),
('def', 'cassa_lan', 'attendee_ibfk_3', 'def', 'cassa_lan', 'attendee', 'tournID', 1, 1, 'cassa_lan', 'tournament', 'tournID'),
('def', 'cassa_lan', 'attendee_ibfk_4', 'def', 'cassa_lan', 'attendee', 'seatID', 1, 1, 'cassa_lan', 'seat', 'seatID'),
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'client', 'clientID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'event', 'eventID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'menu_items_ibfk_1', 'def', 'cassa_lan', 'menu_items', 'menuID', 1, 1, 'cassa_lan', 'pizza_menu', 'menuID'),
('def', 'cassa_lan', 'menu_items_ibfk_2', 'def', 'cassa_lan', 'menu_items', 'pizzaID', 1, 1, 'cassa_lan', 'pizza_type', 'pizzaID'),
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'news', 'newsID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'pizza_menu', 'menuID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'pizza_menu_ibfk_1', 'def', 'cassa_lan', 'pizza_menu', 'eventID', 1, 1, 'cassa_lan', 'event', 'eventID'),
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'pizza_order', 'orderID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'pizza_order_ibfk_2', 'def', 'cassa_lan', 'pizza_order', 'pizzaID', 1, 1, 'cassa_lan', 'pizza_type', 'pizzaID'),
('def', 'cassa_lan', 'pizza_order_ibfk_3', 'def', 'cassa_lan', 'pizza_order', 'attendeeID', 1, 1, 'cassa_lan', 'attendee', 'attendeeID'),
('def', 'cassa_lan', 'pizza_order_ibfk_4', 'def', 'cassa_lan', 'pizza_order', 'seat_number', 1, 1, 'cassa_lan', 'seat', 'seat_number'),
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'pizza_type', 'pizzaID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'seat', 'seatID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'team_attendee_ibfk_1', 'def', 'cassa_lan', 'team_attendee', 'teamID', 1, 1, 'cassa_lan', 'teams', 'teamID'),
('def', 'cassa_lan', 'team_attendee_ibfk_2', 'def', 'cassa_lan', 'team_attendee', 'attendeeID', 1, 1, 'cassa_lan', 'attendee', 'attendeeID'),
('def', 'cassa_lan', 'team_attendee_ibfk_3', 'def', 'cassa_lan', 'team_attendee', 'teamID', 1, 1, 'cassa_lan', 'teams', 'teamID'),
('def', 'cassa_lan', 'team_attendee_ibfk_4', 'def', 'cassa_lan', 'team_attendee', 'attendeeID', 1, 1, 'cassa_lan', 'attendee', 'attendeeID'),
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'teams', 'teamID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'team_name', 'def', 'cassa_lan', 'teams', 'team_name', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'PRIMARY', 'def', 'cassa_lan', 'tournament', 'tournID', 1, NULL, NULL, NULL, NULL),
('def', 'cassa_lan', 'tournament_ibfk_1', 'def', 'cassa_lan', 'tournament', 'eventID', 1, 1, 'cassa_lan', 'event', 'eventID'),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-27 14:11:59', '2012-04-27 14:11:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-27 14:11:59', '2012-04-27 14:11:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-27 14:11:59', '2012-04-27 14:11:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-27 14:11:59', '2012-04-27 14:11:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-27 14:11:59', '2012-04-27 14:11:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-27 14:11:59', '2012-04-27 14:11:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-27 14:11:59', '2012-04-27 14:11:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-27 14:11:59', '2012-04-27 14:11:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-27 14:11:59', '2012-04-27 14:11:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2012-04-27 14:11:59', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'attendee', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 65536, 5242880, '2012-04-02 14:53:53', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'client', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 5242880, '2012-03-31 03:55:25', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 5242880, '2012-03-30 04:13:22', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'menu_items', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 32768, 5242880, '2012-04-02 15:01:23', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'news', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 626, 1252, 281474976710655, 2048, 0, '2012-04-27 13:58:53', '2012-04-27 13:58:53', NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'pizza_menu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 5242880, '2012-04-02 14:59:59', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'pizza_order', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 49152, 5242880, '2012-04-01 14:28:39', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'pizza_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 5242880, '2012-04-01 14:30:51', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'seat', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 16384, 5242880, '2012-04-01 14:33:02', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'team_attendee', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 32768, 5242880, '2012-04-02 14:51:52', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'teams', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 16384, 5242880, '2012-03-31 03:41:18', NULL, NULL, NULL, '', '', NULL),
('def', 'cassa_lan', 'tournament', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 16384, 5242880, '2012-03-31 03:35:00', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:18', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 440, 2200, 123848989752688639, 5120, 1760, '2011-12-16 21:03:08', '2012-04-19 20:40:25', '2011-12-16 21:03:09', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 40, 40, 281474976710655, 4096, 0, '2011-12-16 21:03:09', '2012-03-06 14:39:48', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:18', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1028, 9, 9252, 2533274790395903, 19456, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 867, 440716, 281474976710655, 20480, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 693, 195062158860484607, 5120, 693, '2011-12-16 21:03:09', '2012-04-19 20:40:25', '2011-12-16 21:03:09', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 112, 500, 281474976710655, 2048, 388, '2011-12-16 21:03:08', '2012-04-19 20:40:25', NULL, NULL, '', '', NULL),
...
(105, 'reader', 'localhost:1713', 'cassa_lan', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'cassa_lan', 'attendee_ibfk_1', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'attendee', 'event'),
('def', 'cassa_lan', 'attendee_ibfk_2', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'attendee', 'client'),
('def', 'cassa_lan', 'attendee_ibfk_3', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'attendee', 'tournament'),
('def', 'cassa_lan', 'attendee_ibfk_4', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'attendee', 'seat'),
('def', 'cassa_lan', 'menu_items_ibfk_1', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'menu_items', 'pizza_menu'),
('def', 'cassa_lan', 'menu_items_ibfk_2', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'menu_items', 'pizza_type'),
('def', 'cassa_lan', 'pizza_menu_ibfk_1', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'pizza_menu', 'event'),
('def', 'cassa_lan', 'pizza_order_ibfk_2', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'pizza_order', 'pizza_type'),
('def', 'cassa_lan', 'pizza_order_ibfk_3', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'pizza_order', 'attendee'),
('def', 'cassa_lan', 'pizza_order_ibfk_4', 'def', 'cassa_lan', 'seat_number', 'NONE', 'CASCADE', 'CASCADE', 'pizza_order', 'seat'),
('def', 'cassa_lan', 'team_attendee_ibfk_1', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'team_attendee', 'teams'),
('def', 'cassa_lan', 'team_attendee_ibfk_2', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'team_attendee', 'attendee'),
('def', 'cassa_lan', 'team_attendee_ibfk_3', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'team_attendee', 'teams'),
('def', 'cassa_lan', 'team_attendee_ibfk_4', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'team_attendee', 'attendee'),
('def', 'cassa_lan', 'tournament_ibfk_1', 'def', 'cassa_lan', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'tournament', 'event');
...
('def', 'cassa_lan', 'latin1', 'latin1_swedish_ci', NULL),
...
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'SELECT', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'INSERT', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'UPDATE', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'DELETE', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'CREATE', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'DROP', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'REFERENCES', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'INDEX', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'ALTER', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'CREATE TEMPORARY TABLES', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'LOCK TABLES', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'EXECUTE', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'CREATE VIEW', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'SHOW VIEW', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'CREATE ROUTINE', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'ALTER ROUTINE', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'EVENT', 'YES'),
('''reader''@''localhost''', 'def', 'cassa\\_lan', 'TRIGGER', 'YES');
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '21173'),
('INNODB_BUFFER_POOL_READS', '424'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1849'),
('INNODB_DATA_FSYNCS', '163'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '119459'),
('UPTIME_SINCE_FLUSH_STATUS', '119459');
...
('def', 'cassa_lan', 'attendee', 0, 'cassa_lan', 'PRIMARY', 1, 'attendeeID', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'attendee', 1, 'cassa_lan', 'eventID', 1, 'eventID', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'attendee', 1, 'cassa_lan', 'eventID', 2, 'clientID', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'attendee', 1, 'cassa_lan', 'eventID', 3, 'tournID', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'attendee', 1, 'cassa_lan', 'clientID', 1, 'clientID', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'attendee', 1, 'cassa_lan', 'clientID', 2, 'tournID', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'attendee', 1, 'cassa_lan', 'tournID', 1, 'tournID', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'attendee', 1, 'cassa_lan', 'seatID', 1, 'seatID', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'client', 0, 'cassa_lan', 'PRIMARY', 1, 'clientID', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'event', 0, 'cassa_lan', 'PRIMARY', 1, 'eventID', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'menu_items', 1, 'cassa_lan', 'menuID', 1, 'menuID', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'menu_items', 1, 'cassa_lan', 'menuID', 2, 'pizzaID', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'menu_items', 1, 'cassa_lan', 'pizzaID', 1, 'pizzaID', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'news', 0, 'cassa_lan', 'PRIMARY', 1, 'newsID', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'pizza_menu', 0, 'cassa_lan', 'PRIMARY', 1, 'menuID', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'pizza_menu', 1, 'cassa_lan', 'eventID', 1, 'eventID', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'pizza_order', 0, 'cassa_lan', 'PRIMARY', 1, 'orderID', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'pizza_order', 1, 'cassa_lan', 'pizzaID', 1, 'pizzaID', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'pizza_order', 1, 'cassa_lan', 'pizzaID', 2, 'attendeeID', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'pizza_order', 1, 'cassa_lan', 'attendeeID', 1, 'attendeeID', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'pizza_order', 1, 'cassa_lan', 'seat_number', 1, 'seat_number', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'pizza_type', 0, 'cassa_lan', 'PRIMARY', 1, 'pizzaID', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'seat', 0, 'cassa_lan', 'PRIMARY', 1, 'seatID', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'seat', 1, 'cassa_lan', 'seat_number', 1, 'seat_number', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'team_attendee', 1, 'cassa_lan', 'TeamID', 1, 'teamID', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'team_attendee', 1, 'cassa_lan', 'TeamID', 2, 'attendeeID', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'team_attendee', 1, 'cassa_lan', 'AttendeeID', 1, 'attendeeID', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'teams', 0, 'cassa_lan', 'PRIMARY', 1, 'teamID', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'teams', 0, 'cassa_lan', 'team_name', 1, 'team_name', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'tournament', 0, 'cassa_lan', 'PRIMARY', 1, 'tournID', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cassa_lan', 'tournament', 1, 'cassa_lan', 'eventID', 1, 'eventID', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'event', 0, 'mysql', 'PRIMARY', 2, 'name', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'proxies_priv', 0, 'mysql', 'PRIMARY', 4, 'Proxied_user', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'proxies_priv', 1, 'mysql', 'Grantor', 1, 'Grantor', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-27 14:12:00', '2012-04-27 14:12:00', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-27 14:12:00', '2012-04-27 14:12:00', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-27 14:12:00', '2012-04-27 14:12:00', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-27 14:12:00', '2012-04-27 14:12:00', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-27 14:12:00', '2012-04-27 14:12:00', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-27 14:12:00', '2012-04-27 14:12:00', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-27 14:12:00', '2012-04-27 14:12:00', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-27 14:12:00', '2012-04-27 14:12:00', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-27 14:12:00', '2012-04-27 14:12:00', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2012-04-27 14:12:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'cassa_lan', 'attendee', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 65536, 5242880, 7, '2012-04-02 14:53:53', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'client', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 5242880, 11, '2012-03-31 03:55:25', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'event', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 5242880, 3, '2012-03-30 04:13:22', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'menu_items', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 32768, 5242880, NULL, '2012-04-02 15:01:23', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'news', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 626, 1252, 281474976710655, 2048, 0, 3, '2012-04-27 13:58:53', '2012-04-27 13:58:53', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'pizza_menu', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 5242880, 3, '2012-04-02 14:59:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'pizza_order', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 49152, 5242880, 9, '2012-04-01 14:28:39', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'pizza_type', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 5242880, 5, '2012-04-01 14:30:51', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'seat', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 16384, 5242880, 11, '2012-04-01 14:33:02', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'team_attendee', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 32768, 5242880, NULL, '2012-04-02 14:51:52', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'teams', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 16384, 5242880, 8, '2012-03-31 03:41:18', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cassa_lan', 'tournament', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 16384, 5242880, 6, '2012-03-31 03:35:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:18', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 440, 2200, 123848989752688639, 5120, 1760, NULL, '2011-12-16 21:03:08', '2012-04-19 20:40:25', '2011-12-16 21:03:09', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 40, 40, 281474976710655, 4096, 0, NULL, '2011-12-16 21:03:09', '2012-03-06 14:39:48', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:18', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1028, 9, 9252, 2533274790395903, 19456, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 867, 440716, 281474976710655, 20480, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 693, 195062158860484607, 5120, 693, NULL, '2011-12-16 21:03:09', '2012-04-19 20:40:25', '2011-12-16 21:03:09', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 00:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 112, 500, 281474976710655, 2048, 388, NULL, '2011-12-16 21:03:08', '2012-04-19 20:40:25', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'attendee', 'PRIMARY KEY'),
('def', 'cassa_lan', 'attendee_ibfk_1', 'cassa_lan', 'attendee', 'FOREIGN KEY'),
('def', 'cassa_lan', 'attendee_ibfk_2', 'cassa_lan', 'attendee', 'FOREIGN KEY'),
('def', 'cassa_lan', 'attendee_ibfk_3', 'cassa_lan', 'attendee', 'FOREIGN KEY'),
('def', 'cassa_lan', 'attendee_ibfk_4', 'cassa_lan', 'attendee', 'FOREIGN KEY'),
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'client', 'PRIMARY KEY'),
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'event', 'PRIMARY KEY'),
('def', 'cassa_lan', 'menu_items_ibfk_1', 'cassa_lan', 'menu_items', 'FOREIGN KEY'),
('def', 'cassa_lan', 'menu_items_ibfk_2', 'cassa_lan', 'menu_items', 'FOREIGN KEY'),
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'news', 'PRIMARY KEY'),
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'pizza_menu', 'PRIMARY KEY'),
('def', 'cassa_lan', 'pizza_menu_ibfk_1', 'cassa_lan', 'pizza_menu', 'FOREIGN KEY'),
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'pizza_order', 'PRIMARY KEY'),
('def', 'cassa_lan', 'pizza_order_ibfk_2', 'cassa_lan', 'pizza_order', 'FOREIGN KEY'),
('def', 'cassa_lan', 'pizza_order_ibfk_3', 'cassa_lan', 'pizza_order', 'FOREIGN KEY'),
('def', 'cassa_lan', 'pizza_order_ibfk_4', 'cassa_lan', 'pizza_order', 'FOREIGN KEY'),
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'pizza_type', 'PRIMARY KEY'),
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'seat', 'PRIMARY KEY'),
('def', 'cassa_lan', 'team_attendee_ibfk_1', 'cassa_lan', 'team_attendee', 'FOREIGN KEY'),
('def', 'cassa_lan', 'team_attendee_ibfk_2', 'cassa_lan', 'team_attendee', 'FOREIGN KEY'),
('def', 'cassa_lan', 'team_attendee_ibfk_3', 'cassa_lan', 'team_attendee', 'FOREIGN KEY'),
('def', 'cassa_lan', 'team_attendee_ibfk_4', 'cassa_lan', 'team_attendee', 'FOREIGN KEY'),
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'teams', 'PRIMARY KEY'),
('def', 'cassa_lan', 'team_name', 'cassa_lan', 'teams', 'UNIQUE'),
('def', 'cassa_lan', 'PRIMARY', 'cassa_lan', 'tournament', 'PRIMARY KEY'),
('def', 'cassa_lan', 'tournament_ibfk_1', 'cassa_lan', 'tournament', 'FOREIGN KEY'),
...
('''reader''@''localhost''', 'def', 'SELECT', 'YES'),
('''reader''@''localhost''', 'def', 'INSERT', 'YES'),
('''reader''@''localhost''', 'def', 'UPDATE', 'YES'),
('''reader''@''localhost''', 'def', 'DELETE', 'YES'),
('''reader''@''localhost''', 'def', 'CREATE', 'YES'),
('''reader''@''localhost''', 'def', 'DROP', 'YES'),
('''reader''@''localhost''', 'def', 'RELOAD', 'YES'),
('''reader''@''localhost''', 'def', 'SHUTDOWN', 'YES'),
('''reader''@''localhost''', 'def', 'PROCESS', 'YES'),
('''reader''@''localhost''', 'def', 'FILE', 'YES'),
('''reader''@''localhost''', 'def', 'REFERENCES', 'YES'),
('''reader''@''localhost''', 'def', 'INDEX', 'YES'),
('''reader''@''localhost''', 'def', 'ALTER', 'YES'),
('''reader''@''localhost''', 'def', 'SHOW DATABASES', 'YES'),
('''reader''@''localhost''', 'def', 'SUPER', 'YES'),
('''reader''@''localhost''', 'def', 'CREATE TEMPORARY TABLES', 'YES'),
('''reader''@''localhost''', 'def', 'LOCK TABLES', 'YES'),
('''reader''@''localhost''', 'def', 'EXECUTE', 'YES'),
('''reader''@''localhost''', 'def', 'REPLICATION SLAVE', 'YES'),
('''reader''@''localhost''', 'def', 'REPLICATION CLIENT', 'YES'),
('''reader''@''localhost''', 'def', 'CREATE VIEW', 'YES'),
('''reader''@''localhost''', 'def', 'SHOW VIEW', 'YES'),
('''reader''@''localhost''', 'def', 'CREATE ROUTINE', 'YES'),
('''reader''@''localhost''', 'def', 'ALTER ROUTINE', 'YES'),
('''reader''@''localhost''', 'def', 'CREATE USER', 'YES'),
('''reader''@''localhost''', 'def', 'EVENT', 'YES'),
('''reader''@''localhost''', 'def', 'TRIGGER', 'YES'),
('''reader''@''localhost''', 'def', 'CREATE TABLESPACE', 'YES');
...
('localhost', 'cassa\\_lan', 'reader', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
INSERT INTO `event` (`db`, `name`, `body`, `definer`, `execute_at`, `interval_value`, `interval_field`, `created`, `modified`, `last_executed`, `starts`, `ends`, `status`, `on_completion`, `sql_mode`, `comment`, `originator`, `time_zone`, `character_set_client`, `collation_connection`, `db_collation`, `body_utf8`) VALUES
('', 'tinashe', '', '', NULL, NULL, NULL, '2012-03-06 14:39:47', '0000-00-00 00:00:00', NULL, NULL, NULL, 'ENABLED', 'DROP', '', '', 0, 'SYSTEM', NULL, NULL, NULL, NULL);
...
('localhost', 'reader', '*FB6E1F205D675BC29B052DB14CCEFE7759C5FF7E', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', NULL);
--
